...
function printHelp() {
    ...
    util.puts('     $ echo \'{"name":"trent","age":38}\' | json -E \'this.age++\'');
    util.puts('     {');
    ...
    util.puts('     $ echo \'[{"age":38},{"age":4}]\' | json -C \'this.age>21\'');
    util.puts('     [{\'age\':38}]');
    util.puts('  If input is an array, this will automatically process each');
    ...
    util.puts('  -e CODE, -c CODE');
    util.puts('                Similar to "-E CODE" and "-C CODE", respectively,');
    util.puts('                but potentially much slower. Deprecated. Remains ');
    util.puts('                for backward compat. See the full docs for details.');
    util.puts('');
